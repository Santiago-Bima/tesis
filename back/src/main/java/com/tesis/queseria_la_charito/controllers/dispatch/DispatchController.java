...
public class DispatchController {
  ...
  @GetMapping("")
  List<DispatchResponse> getAll(@RequestParam(required = false) LocalDate fecha, @RequestParam Long destinoId) { return service.getAll(fecha, destinoId); }

  @PreAuthorize("hasRole('ROLE_Operario'")
  @GetMapping("/{id}")
  DispatchResponse getById(@PathVariable Long id) { return service.getById(id); }

  @PreAuthorize("hasRole('ROLE_Subgerente'")
  @PostMapping("")
  DispatchResponse post(@RequestBody DispatchRequest despachoRequest) { return service.post(despachoRequest); }

  @PreAuthorize("hasRole('ROLE_Subgerente'")
  @PutMapping("/{id}")
  DispatchResponse put(@PathVariable Long id, @RequestBody DispatchUpdateRequest despachoUpdateRequest) { return service.put(despachoUpdateRequest, id); }

  @PreAuthorize("hasAnyRole('ROLE_Subgerente', 'ROLE_Operario'")
  @DeleteMapping("/{id}")
  DispatchResponse delete(@PathVariable Long id) { return service.delete(id); }
  ...
  List<DispatchResponse> getByUser(@PathVariable String username) { return service.getByUser(username); }

  @PreAuthorize("hasRole('ROLE_Operario'")
  @PutMapping("/cambiar-estado/{id}")
  DispatchResponse changeStatus(@PathVariable Long id) { return service.changeEstado(id); }
}
